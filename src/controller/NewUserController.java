...
public class NewUserController implements Initializable {
    ...
    @FXML TextField nombre,apellido,usuario;
    @FXML PasswordField pass,cpass;    
    @FXML Label topPane;
    @FXML ComboBox lvl;
    ...
    @FXML public void onKeyPressed(KeyEvent evt){
   ...
   @FXML public void register(ActionEvent evt) throws SQLException{
       dm=new DataManager();
