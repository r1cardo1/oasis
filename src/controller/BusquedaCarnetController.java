...
public class BusquedaCarnetController implements Initializable {
    ...
    public void continuar() throws IOException {
        if (!table.getSelectionModel().isEmpty()) {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/GeneraCarnet.fxml"));
            aux.getChildren().add(loader.load());
            GeneraCarnetController controller = loader.getController();
            controller.menu = myController;
            controller.host = this.host;
            controller.usuario = this.user;
