...
public class VisitasController implements Initializable {
    ...
    @FXML TableColumn<Asistencia, String> cedula;
    @FXML TableColumn<Asistencia, String> nombre;
    @FXML TableColumn<Asistencia, String> contrato;
    @FXML TableColumn<Asistencia, String> plan;
    @FXML TableColumn<Asistencia, String> fecha;
    @FXML TableColumn<Asistencia, String> hora;
    @FXML TableColumn<Asistencia, String> nmesa;
    @FXML TableColumn<Asistencia, String> ninvitados;
      ...
      public void changePane(String old, String neww){
          ...
          case "CEDULA":
              if(!neww.equals("CONTRATO") || !neww.equals("NOMBRE"))
                  pfilter.setVisible(false);
          break;
          case "FECHA":pdate.setVisible(false);
          break;
          case "RANGO DE FECHA":rangeDate.setVisible(false);
          break;
      }
          switch(neww){
              case "NOMBRE":
              ...
              case "CEDULA":
                  if(!old.equals("CONTRATO") || !old.equals("NOMBRE"))
                      pfilter.setVisible(true);
              break;
              case "FECHA":pdate.setVisible(true);
              break;
              case "RANGO DE FECHA":rangeDate.setVisible(true);
              break;
          }
      }
