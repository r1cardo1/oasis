...
public class DataManager {
      ...
      public ArrayList<Usuario> searchUserbyUsername(String u) {
            ArrayList<Usuario> list = new ArrayList<>();
            rs = null;
            try {
      ...
      public ArrayList<Busqueda> getAllSearch() {
            ArrayList<Busqueda> list = new ArrayList<>();
            try {
      ...
      public ArrayList<Login> getLogLogins() {
            ArrayList<Login> list = new ArrayList<>();
            try {
      ...
      public ArrayList<Plan> getPlans() {
            ...
            try {
                  ...
                  rs = st.executeQuery(query);
                  while (rs.next()) {
                        list.add(new Plan(rs.getString("plan"), rs.getInt("invitados")));
                  }
                  return list;
            } catch (Exception e) {
                  System.out.println(e.getMessage());
      ...
      public ArrayList<Invitado> getInvitados() {
            ...
            try {
                  ...
                  rs = st.executeQuery(query);
                  while (rs.next()) {
                        list.add(new Invitado(rs.getString("nombre"), rs.getString("apellido"), rs.getString("cedula"), rs.getString("contrato"), rs.getString("fecha")));
                  }
                  return list;
            } catch (Exception ex) {
      ...
      public ArrayList<Asistencia> getAsistenciaPorContrato(String contrato) {
            ArrayList<Asistencia> list = new ArrayList<>();
            try {
      ...
      public ArrayList<Reserva> getReservas() {
            ...
            try {
                  ...
                  rs = st.executeQuery(query);
                  while (rs.next()) {
                        list.add(new Reserva(rs.getString("titular"), rs.getString("cedula"),
                                rs.getString("telefono"), rs.getString("plan"),
                                rs.getString("invitados"), rs.getString("fecha"),
      ...
      public ArrayList<Reserva> getReservasByName(String titular) {
            ArrayList<Reserva> list = new ArrayList<>();
            try {
      ...
      public ArrayList<Reserva> getReservasByCI(String ci) {
            ArrayList<Reserva> list = new ArrayList<>();
            try {
      ...
      public int getCantByPlan(String plan) {
            int cant = 0;
            try {
                  String query = "SELECT * FROM oasisclub.planes WHERE plan = '" + plan + "';";
                  rs = st.executeQuery(query);
                  if (rs.next()) {
                        cant = rs.getInt("invitados");
                  }
                  return cant;
            } catch (Exception e) {
                  System.out.println(e.getMessage());
